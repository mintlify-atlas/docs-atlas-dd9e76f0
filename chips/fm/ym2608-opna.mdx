---
title: Yamaha YM2608 (OPNA)
description: Enhanced OPN with 6 FM channels, SSG, ADPCM, and rhythm drums
---
...
The YM2610 (OPNB) and YM2610B chips are very similar to this one, but in those the rhythm channels become general ADPCM channels and the built-in drum samples are removed.
